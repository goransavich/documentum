				...
				<div class="col-md-6">
					...
					<div class="inputdata col-md-8">
						<div class="inputfield-date">
							<input name="subject_date" type="text" value="<?php echo e($today_date); ?>" disabled>
						</div>
...
<script>
    ...
    $("#choose-mun-from-create-subject").on('change',function() {
        ...
        $.ajax({
        	type: 'get',
        	url: "<?php echo URL::to('getmunicipality'); ?>",
        	data: {'id':munID},
